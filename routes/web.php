...
// Fallback to the application shell only for authenticated users.
// This prevents exposing the app shell and shared props to unauthenticated visitors.
Route::middleware('auth')->get('/{any}', fn() => Inertia::render('App'))
    ->where('any', '.*');
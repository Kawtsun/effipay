...
// You can adjust or import these styles as needed
...
// Copy the prop types from PayslipTemplate
...
const PayslipBox: React.FC<PayslipBoxProps> = ({ payPeriod, employeeName = '-', role = '', earnings, deductions, totalDeductions, totalHours, collegeRate }) => {
  ...
  return (
    <View style={styles.payslipBox}>
      ...
      {/* Cashier Signature Section and System Generated Message - Below Both Columns */}

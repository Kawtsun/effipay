...
export function calculateOvertimePay(date: string, baseAmount: number): number {
    ...
    if (dayOfWeek >= 1 && dayOfWeek <= 5) {
        ...
        return parseFloat((baseAmount * 0.3).toFixed(2));
    }
}
...
export function calculateSSS(base_salary: number): number {
    const brackets = [
        ...
        { min: 34750, max: Infinity, value: 1750.0 },
    ];
...
export function calculateWithholdingTax(baseSalary: number, sss: number, pagIbig: number, philhealth: number): number {
    ...
    const brackets = [
        ...
        { min: 33333, max: 66666, rate: 0.2, base: 1875, excess: 33333 },
        { min: 66667, max: 166666, rate: 0.25, base: 8541.8, excess: 66667 },
        { min: 166667, max: 666666, rate: 0.3, base: 33541.8, excess: 166667 },
        { min: 666667, max: Infinity, rate: 0.35, base: 183541.8, excess: 666667 },
    ];
    for (const b of brackets) {
